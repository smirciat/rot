...
class OmeComponent {
  constructor($http,$state,uiGridConstants,moment) {
    ...
    this.gridOptions2={rowHeight:22,
                      ...
                      {name:'297',field:'297ExpShort',minWidth:90,cellClass:this.cellClass },
                      {name:'Autopilot',field:'297gExpShort',minWidth:90,cellClass:this.cellClass },
                      {name:'299',field:'299ExpShort',minWidth:90,cellClass:this.cellClass },
